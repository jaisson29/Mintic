...
-- 
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `grupo_24` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `grupo_24` ;
...
CREATE TABLE IF NOT EXISTS `grupo_24`.`docente_titulo` (
  ...
  PRIMARY KEY (`titulo_id`, `docente_cedula`),
...
CREATE TABLE IF NOT EXISTS `grupo_24`.`estudiante_asignatura` (
  ...
  PRIMARY KEY (`asignatura_codigo`, `estudiante_tarjeta_identidad`),
